...
2. Hetzner firewall rules expose all TCP ports to admin CIDRs for operations.
3. HTTP, HTTPS, and the public app port range `3001-3100/tcp` are open for deployed applications.
...
Dokploy's official installer expects ports `80`, `443`, and `3000` to be free. This stack opens all TCP ports to `allowed_admin_cidrs`, and opens `80`, `443`, and `3001-3100/tcp` publicly for apps.

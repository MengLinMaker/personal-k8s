...
| `headlamp` | `https://kubernetes-sigs.github.io/headlamp/` | `0.43.0` | `headlamp` | Provides a lightweight Kubernetes web UI for inspecting pods, nodes, logs, and events without installing a full monitoring stack. It is exposed on NodePort `30080` for admin CIDRs only. |
